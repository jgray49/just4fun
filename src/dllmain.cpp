...
HRESULT APIENTRY MJPresent(IDXGISwapChain* pSwapChain, UINT SyncInterval, UINT Flags) {
	...
	if (GetAsyncKeyState(VK_DELETE) & 1) Settings::bShowMenu = !Settings::bShowMenu;
...
DWORD WINAPI MainThread(LPVOID lpParameter) {
	Beep(600, 100); Beep(600, 100);

	Offsets::BaseAddress = (DWORD)GetModuleHandle(NULL);
	GameObject* LocalPlayer = (GameObject*)(*(DWORD*)(Offsets::BaseAddress + Offsets::oLocalPlayer));
